...
cycle_cee = cycle + '0';
write(STDOUT_FILENO, names, strings_length(names));
write(STDOUT_FILENO, ": ", 2);
write(STDOUT_FILENO, &cycle_cee, 1);
write(STDOUT_FILENO, ": ", 2);
write(STDOUT_FILENO, commands[0], strings_length(commands[0]));
